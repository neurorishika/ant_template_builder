...
cp obiroi_cns_$DATE/affine/affine_template.nii.gz ./affine_template.nii.gz
cp obiroi_cns_$DATE/affine/affine_template.nii.gz obiroi_cns_$DATE/affine_template.nii.gz
...
mv *.cfg obiroi_cns_$DATE/syn
mv GR* obiroi_cns_$DATE/syn
...
cp obiroi_cns_$DATE/syn/complete_template.nii.gz obiroi_cns_$DATE/complete_template.nii.gz
