...
# FORMAT: obiroi_cns_btp_<DATE>

mkdir obiroi_cns_btp_$DATE

# Create a subdirectory for the affine registration
# FORMAT: obiroi_cns_btp_<DATE>/affine

mkdir obiroi_cns_btp_$DATE/affine

# Create a subdirectory for the syn registration
# FORMAT: obiroi_cns_btp_<DATE>/syn

mkdir obiroi_cns_btp_$DATE/syn
...
mv GR* obiroi_cns_btp_$DATE/affine
...
cp obiroi_cns_btp_$DATE/affine/affine_template.nii.gz ./affine_template.nii.gz
cp obiroi_cns_btp_$DATE/affine/affine_template.nii.gz obiroi_cns_btp_$DATE/affine_template.nii.gz
...
mv complete_* obiroi_cns_btp_$DATE/syn
mv stdout-syn-template.txt obiroi_cns_btp_$DATE/syn
mv stderr-syn-template.txt obiroi_cns_btp_$DATE/syn
mv *.cfg obiroi_cns_btp_$DATE/syn
mv GR* obiroi_cns_btp_$DATE/syn
...
cp obiroi_cns_btp_$DATE/syn/complete_template.nii.gz obiroi_cns_btp_$DATE/complete_template.nii.gz
...
mv obiroi_cns_btp_$DATE ../results
